...
import org.springframework.http.HttpStatus;
    ...
    METHOD_NOT_ALLOWED(HttpStatus.METHOD_NOT_ALLOWED, "C012", "지원하지 않는 요청 메서드입니다."),
    ...
    REFUND_WINDOW_EXPIRED(HttpStatus.CONFLICT, "ORD011", "결제 후 7일이 지나 환불할 수 없습니다."),
    REFUND_PROGRESS_EXCEEDED(HttpStatus.CONFLICT, "ORD012", "진도율 10% 이상 수강한 강의는 환불할 수 없습니다."),
    // 순공 세션 관련 예외
    ...
    SCHEDULE_DATE_RANGE_INVALID(HttpStatus.BAD_REQUEST, "SC005", "조회 시작일은 종료일 이후일 수 없습니다."),
    SCHEDULE_DATE_RANGE_TOO_LONG(HttpStatus.BAD_REQUEST, "SC006", "학습 스케줄은 최대 1년치까지만 조회할 수 있습니다.");
